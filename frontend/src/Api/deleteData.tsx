...
export const deleteCommentData = async (commentId: string) => {
  try {
    ...
    await axios.delete(
      `http://ec2-3-83-39-212.compute-1.amazonaws.com:8000/comments/${commentId}`
    );
  } catch (error) {
...
export const deleteFitnessTaskData = async (
  ...
  await axios.delete(
    `http://ec2-3-83-39-212.compute-1.amazonaws.com:8000/fitness/${username}/${taskId}/delete`,
    {
      headers: {
        "Content-Type": "application/json",
      },
...
export const deleteUser = async (username: string): Promise<void> => {
  try {
    ...
    await axios.delete(
      `http://ec2-3-83-39-212.compute-1.amazonaws.com:8000/users/admin/${username}`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
