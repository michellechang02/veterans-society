    ...
    <Center h="100vh">
      ...
      >
          ...
          {step === 2 && (
            <>
              <FormControl id="interests">
                <FormLabel fontSize="lg">What are your interests?</FormLabel>
                <Stack spacing={2}>
                  <RadioGroup
                    name="interests"
                    onChange={(value) =>
        ...
        <Text mt={6} textAlign="center" fontSize="lg">
          Already have an account? <Button variant="link" colorScheme="gray" onClick={() => navigate('/login')}>Login</Button>
        </Text>
      </Box>
    </Center>
  );
